// internal/app/features/mhsdashboard2/dashboard.go
...
// ServeDashboard renders the main MHS dashboard 2 page.
func (h *Handler) ServeDashboard(w http.ResponseWriter, r *http.Request) {
	...
	if len(groups) == 0 {
		...
		templates.Render(w, r, "mhsdashboard2_view", data)
		return
	}
...
func (h *Handler) ServeGrid(w http.ResponseWriter, r *http.Request) {
	...
	if len(groups) == 0 {
		...
		templates.Render(w, r, "mhsdashboard2_grid", data)
		return
	}
