// internal/app/features/missionhydrosci/content.go
...
// ContentFallback returns an http.Handler that redirects /missionhydrosci/content/* requests
...
func (h *Handler) ContentFallback() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Extract the path after /missionhydrosci/content/
		path := r.URL.Path
		prefix := "/missionhydrosci/content/"
