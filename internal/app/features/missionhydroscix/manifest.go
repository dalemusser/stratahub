// internal/app/features/missionhydroscix/manifest.go
...
var manifestData = pwaManifest{
	Name:            "Mission HydroSci X (Dev)",
	ShortName:       "MHS X Dev",
	Description:     "Mission HydroSci X (Dev) - Science Adventure Game",
	StartURL:        "/missionhydroscix/units",
	Scope:           "/",
	Display:         "standalone",
...
func init() {
	...
	templates.RegisterFunc("missionhydroscixManifestVersion", func() string { return version })
}
