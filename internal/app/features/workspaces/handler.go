...
func NewHandler(db *mongo.Database, store storage.Store, gsStore *globalsettings.Store, errLog *uierrors.ErrorLogger, audit *auditlog.Logger, primaryDomain string, logger *zap.Logger) *Handler {
	return &Handler{
		DB:                  db,
		Storage:             store,
