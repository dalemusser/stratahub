...
type AppConfig struct {
	...
	DefaultWorkspaceSubdomain string
...
func (h *Handler) buildConfigGroups() []ConfigGroup {
	...
	groups = append(groups, ConfigGroup{
		Name: "Workspace",
		Items: []ConfigItem{
			{Name: "multi_workspace", Value: boolStr(h.AppCfg.MultiWorkspace)},
			{Name: "primary_domain", Value: h.AppCfg.PrimaryDomain},
			{Name: "default_workspace_name", Value: h.AppCfg.DefaultWorkspaceName},
			{Name: "default_workspace_subdomain", Value: h.AppCfg.DefaultWorkspaceSubdomain},
			{Name: "superadmin_email", Value: h.AppCfg.SuperAdminEmail},
		},
	})
