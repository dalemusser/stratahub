...
// OrgID normalizes an organization ID from form input.
// Trims whitespace and converts "all" to empty string so validation
// will properly catch it as a missing required field.
func OrgID(s string) string {
