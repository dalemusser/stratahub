...
| `waffle/pantry/` | Framework utilities (reusable) | Email validation, MongoDB helpers |
...
import "github.com/dalemusser/stratahub/internal/app/system/paging"
...
- Consider moving code to `waffle/pantry` if it could benefit other apps
