...
- **Multi-workspace architecture:** logically isolated environments for independent research deployments
...
- **Multiple authentication methods:** Google, Clever, ClassLink, email verification, and optional password-based authentication depending on deployment requirements
...
- **MHS Dashboard:** near-real-time progress grid showing every student's status across all units and 26 progress points
...
- **Activity tracking:** login session and StrataHub feature usage monitoring for students and teachers
...
- **Data isolation:** logical separation of data between workspaces and role-scoped visibility within workspaces
